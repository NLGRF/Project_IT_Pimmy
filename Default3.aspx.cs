     ...
     private Paragraph GetFooter()
               {
                   ...
                   BaseFont fontthai1 = BaseFont.CreateFont(Server.MapPath("/Fonts/TH Krub Bold.ttf"), BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
                   ...
                   para.Add(new Phrase(Activity, normal1));
                   para.Add(new Phrase(" \t \t \t"));
                   para.Add(new Phrase("สถานที่" + "\t \t", normal));
                   para.Add(new Phrase(place, normal1));
                   para.Add(new Phrase("\n"));
                   para.Add(new Phrase("ทั้งนี้ขอรับอุปกรณ์ในวันที่" + "\t \t", normal));
                   para.Add(new Phrase(Get_Equipment, normal1));
                   para.Add(new Phrase(" \t \t \t"));
                   para.Add(new Phrase("และส่งคืนในวันที่" + "\t \t", normal));
                   para.Add(new Phrase(Return_Equipment, normal1));
                   para.Add(new Phrase(" \t \t \t"));
                   para.Add(new Phrase("รวมระยะเวลายืม" + "\t \t", normal));
                   para.Add(new Phrase(Total_use, normal1));
                   para.Add(new Phrase(" \t \t \t"));
                   para.Add(new Phrase("วัน", normal1)); 
                   para.Add(new Phrase("\n"));
                   para.Add(new Phrase("โดยหมอบหมายให้" +"\t \t", normal));
                   para.Add(new Phrase(assign_to, normal1));
                  
                   para.Add(new Phrase(" หน่วยงาน"+"\t \t", normal));
                   para.Add(new Phrase(Department, normal1));
                   para.Add(new Phrase("\n"));
                   para.Add(new Phrase("หมายเลขบัตรประจำประชาชน"+"\t \t", normal));
                   para.Add(new Phrase(EN_Equipment, normal1));
